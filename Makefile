...
CXXFLAGS = -g -O2 -I/usr/include/SDL2 -D_GNU_SOURCE=1 -D_REENTRANT
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
STRIP = 
VERSION = 0.98.1
abs_builddir = /home/novous/Desktop/openglad-master
abs_srcdir = /home/novous/Desktop/openglad-master
...
docdir = ${DESTDIR}/$(prefix)/share/doc/openglad
dvidir = ${docdir}
...
#dist-hook:
#	cd pix; ../util/gladpack p ../openglad-0.98.1/graphics.001 *.pix
#	cd scen; ../util/gladpack p ../openglad-0.98.1/levels.001 *.fss
